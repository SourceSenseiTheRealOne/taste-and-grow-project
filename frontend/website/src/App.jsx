...
import { Sprout, Users, ShoppingCart, TrendingUp, Wheat, Droplet, Citrus, Menu, X, Package } from 'lucide-react'
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <Button className="bg-green-600 hover:bg-green-700 text-white">Login / Signup</Button>
            </nav>
          ...
          {mobileMenuOpen && (
            <div className="md:hidden mt-4 pb-4 border-t border-gray-200 pt-4">
              <nav className="flex flex-col space-y-4">
                ...
                <a href="#food-kits" className="text-gray-700 hover:text-green-600 transition-colors font-medium">Food Kits</a>
                <a href="#contact" className="text-gray-700 hover:text-green-600 transition-colors font-medium">Contact</a>
                <Button className="bg-green-600 hover:bg-green-700 text-white w-full">Login / Signup</Button>
              </nav>
            </div>
          )}
        </div>
